...
export let stir = linker.addKernel({
    ...
    dependencies: ["polevl"],
    constants: [
        defineConstant("STIR", types.array.float, [
            -2.705194986674176E-003, 3.473255786154910E-003, 8.333331788340907E-002
        ]),
        defineConstant("MAXSTIR", types.scalar.float, 26.77),
        defineConstant("SQTPIF", types.scalar.float, 2.50662827463100050242)
    ],
    code: `
...
export let gamma = linker.addKernel({
    ...
    constants: [
        defineConstant("P", types.array.float,  [
